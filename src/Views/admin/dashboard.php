...
<section class="section section-last priority-6 color-scheme-1 switcher-item-9">
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3" style="background-color: black; padding:25px; color:black" >
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="1082" height="456" style="display: block; height: 365px; width: 866px;"></canvas>
