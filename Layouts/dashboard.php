...
<head>
    ...
    <!-- Datatable -->
    <link href="<?php echo ('/ressources/vendor/datatables/css/jquery.dataTables.min.css');?>" rel="stylesheet">
    <!-- Custom Stylesheet -->
    <link href="<?php echo ('/ressources/vendor/bootstrap-select/dist/css/bootstrap-select.min.css');?>"  rel="stylesheet">
    <link href="<?php echo ('/ressources/css/style.css');?>"  rel="stylesheet">
...
<body>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4> Hello ! <?php echo UpercaseFirst($user['nom']) ; ?></h4>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="<?php echo ('/ressources/vendor/global/global.min.js' );?>"></script>
	<script src="<?php echo ('/ressources/vendor/bootstrap-select/dist/js/bootstrap-select.min.js' );?>"></script>
    <script src="<?php echo ('/ressources/js/custom.min.js' );?>"></script>
	<script src="<?php echo ('/ressources/js/deznav-init.js' );?>"></script>
	
    <!-- Datatable -->
    <script src="<?php echo ('/ressources/vendor/datatables/js/jquery.dataTables.min.js' );?>"></script>
    <script src="<?php echo ('/ressources/js/plugins-init/datatables.init.js');?>"></script>
